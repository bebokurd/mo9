function loophalaman(a) {
    ...
    nomerhal > 1 &&
        (e +=
            2 == nomerhal
                ? "page" == jenis
                    ...
                    : '<span class="showpageNum"><a href="#/page/' + lblname1 + "?&max-results=" + postperpage + '">' + upPageWord + "</a></span>"
                : "page" == jenis
        ...
        mulai > 1 && (e += "page" == jenis ? '<span class="showpageNum"><a href="' + home_page + '">1</a></span>' : '<span class="showpageNum"><a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></span>'),
        mulai > 2 && (e += "");
    for (var r = mulai; r <= akhir; r++)
        e +=
            nomerhal == r
...
function halamanblogger() {
    var a = urlactivepage;
    -1 != a.indexOf("/search/label/") && (lblname1 = -1 != a.indexOf("?updated-max") ? a.substring(a.indexOf("#/page/") + 14, a.indexOf("?updated-max")) : a.substring(a.indexOf("#/page/") + 14, a.indexOf("?&max"))),
        -1 == a.indexOf("?q=") &&
            -1 == a.indexOf(".html") &&
            (-1 == a.indexOf("#/page/")
                ? ((jenis = "page"),
...
function finddatepost(a) {
    ...
    else var r = "#/page/" + lblname1 + "?updated-max=" + s + "&max-results=" + postperpage + "#PageNo=" + nopage;
    location.href = r;
}
